...
import { API_Header, API_NIPOS } from "../../libs";
    ...
    try {
       await API_NIPOS.put(`/${connote_resi}`, {
        ...
        "currentLocation": {
          ...
          "vehicle_name": "",
          "vehicle_type": "",
          "r7_id": "05da2997661caf9bbadd"
        },
        "content-history": [
          {
            "content": "Barang anda telah melewati proses Receiving oleh Test1 (test1) di Jakartapusatgambir",
            "action": "R7",
            "created_at": "2021-02-18 14:31:50",
            "connote_code": "{{resi_id}}",
            "connote_state": "R7",
            "username": "test1",
            "location_name": "Jakartapusatgambir",
            "coordinate": "-6.33921,106.7169294"
          }
        ]
      });
    } catch (error) {
